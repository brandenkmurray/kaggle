...
ts1Trans = pd.read_csv("/media/branden/SSHD1/kaggle/bnp/data_trans/ts2Trans_v19.csv") 
...
#                     EarlyStopping(patience=200),
                 ...
                 verbose=1,
                 batch_iterator_train=BatchIterator(6400),
                 max_epochs=500)
...
# Save 
foldPred.to_csv("/media/branden/SSHD1/kaggle/bnp/stack_models/cvPreds/cvPreds_nn2.csv", index=False)
...
# Save 
test_pred_frame.to_csv("/media/branden/SSHD1/kaggle/bnp/stack_models/testPreds/testPreds_nn2.csv", index=False)
