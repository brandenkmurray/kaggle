...
# Save 
foldPredAdj.to_csv("/media/branden/SSHD1/kaggle/bnp/stack_models/cvPreds/cvPreds_nn3.csv", index=False)
...
# Save 
test_pred_frame.to_csv("/media/branden/SSHD1/kaggle/bnp/stack_models/testPreds/testPreds_nn3.csv", index=False)
