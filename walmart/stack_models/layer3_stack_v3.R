...
for (p in 1:nrow(xComb)){
  tmp <- xgbLay2_v14$pred*xComb[p,1] + xgbLay2_v15$pred*xComb[p,2] + nnLay2_v1*xComb[p,3]
...
blendedPreds <- xgbLay2_v14_fullpreds*.3 + xgbLay2_v15_fullpreds*.4 + nnLay2_v1_fullpreds*.3
...
write.csv(submission, "./stack_models/blendedPreds_v3.csv", row.names=FALSE)
