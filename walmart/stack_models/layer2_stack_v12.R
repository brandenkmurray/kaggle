...
lay1preds <- cbind(xgb1preds, xgb2preds, xgb3preds, xgb7preds, kknn1preds, nn1preds, nn2preds, et1preds)
...
lay1fullpreds <- cbind(xgb1fullpreds, xgb2fullpreds, xgb3fullpreds, xgb7fullpreds, kknn1fullpreds, nn1fullpreds, nn2fullpreds, et1fullpreds)
...
write.csv(submission, "./stack_models/xgbLay2_v12_preds.csv", row.names=FALSE)
