...
lay1preds <- cbind(xgb1preds, xgb2preds, xgb3preds, xgb7preds, xgb8preds, xgb9preds, kknn1preds, nn1preds, nn2preds, et1preds, glmnet1preds)
...
# eta=0.02,maxdep=3, minchild=1, subsample=0.7, colsample=0.7, xgb1, xgb2, xgb3, xgb7, kknn1, nn1, nn2, et1,glmnet1 =0.555376          0.002674
...
rounds <- floor(which.min(xgbLay2_v14$dt$test.mlogloss.mean) * 1.15)
...
lay1fullpreds <- cbind(xgb1fullpreds, xgb2fullpreds, xgb3fullpreds, xgb7fullpreds, xgb8fullpreds, xgb9fullpreds, kknn1fullpreds, nn1fullpreds, nn2fullpreds, et1fullpreds, glmnet1fullpreds)
...
write.csv(submission, "./stack_models/xgbLay2_v14preds.csv", row.names=FALSE)
