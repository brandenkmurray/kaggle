...
ts1Trans3$TripType38_helper <- ts1Trans3$`GROCERY DRY GOODS` + ts1Trans3$DAIRY + ts1Trans3$`COMM BREAD` + ts1Trans3$`PRE PACKED DELI`
ts1Trans3$TripType39_helper <- ts1Trans3$`PETS AND SUPPLIES` + ts1Trans3$`PERSONAL CARE` + ts1Trans3$`HOUSEHOLD CHEMICALS/SUPP` + ts1Trans3$BEAUTY + ts1Trans3$`PHARMACY OTC`
ts1Trans3$TripType7_helper <- ts1Trans3$BAKERY + ts1Trans3$`COMM BREAD` + ts1Trans3$DAIRY + ts1Trans3$`DSD GROCERY` + ts1Trans3$`FROZEN FOODS` + ts1Trans3$`GROCERY DRY GOODS` + ts1Trans3$`MEAT - FRESH & FROZEN` + ts1Trans3$`PRE PACKED DELI` + ts1Trans3$PRODUCE +  + ts1Trans3$`SERVICE DELI`
ts1Trans3$TripType8_helper <- ts1Trans3$DAIRY + ts1Trans3$`DSD GROCERY` + ts1Trans3$`PERSONAL CARE` + ts1Trans3$BEAUTY + ts1Trans3$`GROCERY DRY GOODS` + ts1Trans3$`IMPULSE MERCHANDISE` + ts1Trans3$PRODUCE
ts1Trans3$TripType9_helper <- ts1Trans3$AUTOMOTIVE + ts1Trans3$CELEBRATION + ts1Trans3$`MENS WEAR` + ts1Trans3$`OFFICE SUPPLIES`
ts1Trans3$TripType35_helpter <- ts1Trans3$`CANDY, TOBACCO, COOKIES` + ts1Trans3$`DSD GROCERY` + ts1Trans3$`IMPULSE MERCHANDISE`
ts1Trans3$TripType36_helper <- ts1Trans3$BEAUTY + ts1Trans3$`PERSONAL CARE` + ts1Trans3$`PHARMACY OTC` + ts1Trans3$`PETS AND SUPPLIES`


write.csv(ts1Trans3, "./data_trans/ts1Trans3.csv", row.names = F)