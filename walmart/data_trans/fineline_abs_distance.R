...
ts1Trans <- data.table(read_csv("./data_trans/ts1Trans3_abs.csv"))
...
write_csv(ts1_fine_simil_diffuse, "./data_trans/ts1_fine_simil_diffuse.csv")
write_csv(ts1_fine_dist_diffuse, "./data_trans/ts1_fine_dist_diffuse.csv")
