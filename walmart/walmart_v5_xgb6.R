...
preds <- predict(xgb6, data.matrix(ts1Trans[filter==2, varnames, with=FALSE]))
...
write.csv(submission, "submit-xgb6-11-2-2015.csv", row.names=FALSE)

submission2 <- read.csv("submit-xgb6-11-2-2015.csv")
