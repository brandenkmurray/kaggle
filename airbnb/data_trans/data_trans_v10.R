...
sess_transform <- function(data){
  x <- data[, list(n=length(secs_elapsed),
                   ...
                   thirdlastAction = action[.N-2],
                   secondlastAction = action[.N-1],
                   lastAction = action[.N],
                   firstActionType = action_type[1],
                   secondActionType = action_type[2],
                   thirdlastActionType = action_type[.N-2],
                   secondlastActionType = action_type[.N-1],
                   lastActionType = action_type[.N],
                   firstActionDet = action_detail[1],
                   secondActionDet  = action_detail[2],
                   thirdlastActionDet  = action_detail[.N-2],
                   secondlastActionDet  = action_detail[.N-1],
                   lastActionDet  = action_detail[.N],
                   firstDevice = device_type[1],
                   lastDevice = device_type[.N],
...
colnames(ts1_pp) <- sub("-","",names(ts1_pp))
colnames(ts1_pp) <- gsub("`","",names(ts1_pp))
...
write_csv(ts1_pp, "./data_trans/ts1_pp_v10.csv")
