...
ts1Trans = pd.read_csv("/home/branden/Documents/kaggle/airbnb/data_trans/ts1_pp_v8.csv") 
...
# Save 
foldPredFrame.to_csv("/home/branden/Documents/kaggle/airbnb/stack_models/cvPreds_nn3.csv", index=False)
...
# Save 
test_pred_frame.to_csv("/home/branden/Documents/kaggle/airbnb/stack_models/testPredsProbs_nn3.csv", index=False)
...
# Save 
testPredFrame.to_csv("/home/branden/Documents/kaggle/airbnb/stack_models/testPredsProbs_nn3.csv", index=False)
