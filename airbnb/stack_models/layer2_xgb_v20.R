...
xgb18cv <- read_csv("./stack_models/cvPreds_xgb18.csv")
xgb19cv <- read_csv("./stack_models/cvPreds_xgb19.csv")
...
load("./stack_models/xgbLay2_v1.rda")
load("./stack_models/xgbLay2_v2.rda")
load("./stack_models/xgbLay2_v7.rda")
load("./stack_models/xgbLay2_v9.rda")
load("./stack_models/xgbLay2_v10.rda")
load("./stack_models/xgbLay2_v11.rda")
load("./stack_models/xgbLay2_v13.rda")
load("./stack_models/xgbLay2_v16.rda")
load("./stack_models/xgbLay2_v18.rda")
...
glmnet1cv$id <- NULL
rf1cv$id <- NULL
lay1preds <- cbind(xgb4cv, xgb5cv, xgb6cv, xgb14cv, xgb15cv, xgb17cv, xgb18cv, xgb19cv, nn1cv, nn2cv, nn3cv, nn4cv, glmnet1cv, rf1cv,
                   xgbLay2_v1$pred, xgbLay2_v2$pred, xgbLay2_v7$pred, xgbLay2_v9$pred, xgbLay2_v10$pred, xgbLay2_v11$pred, xgbLay2_v13$pred, xgbLay2_v16$pred, xgbLay2_v18$pred)
...
set.seed(201510)
(tme <- Sys.time())
xgbLay2_v20 <- xgb.cv(data = dtrain,
                      params = param,
                      nrounds = 10000,
                      # feval = ndcg5,
                      maximize=TRUE,
...
Sys.time() - tme
save(xgbLay2_v20, file="./stack_models/xgbLay2_v20.rda")

xgbLay2_v20$dt[which.max(xgbLay2_v20$dt$test.ndcg5.mean),]
rounds <- floor(which.max(xgbLay2_v20$dt$test.ndcg5.mean) * 1.15)
...
xgb18fullpreds <- read_csv("./stack_models/testPredsProbs_xgb18.csv")
xgb19fullpreds <- read_csv("./stack_models/testPredsProbs_xgb19.csv")
...
testPreds_xgbLay2_v1 <- read_csv("./stack_models/lay2PredsProbs_xgb1.csv")
testPreds_xgbLay2_v2 <- read_csv("./stack_models/lay2PredsProbs_xgb_v2.csv")
testPreds_xgbLay2_v7 <- read_csv("./stack_models/lay2PredsProbs_xgb_v7.csv")
testPreds_xgbLay2_v9 <- read_csv("./stack_models/lay2PredsProbs_xgb_v9.csv")
testPreds_xgbLay2_v10 <- read_csv("./stack_models/lay2PredsProbs_xgb_v10.csv")
testPreds_xgbLay2_v11 <- read_csv("./stack_models/lay2PredsProbs_xgb_v11.csv")
testPreds_xgbLay2_v13 <- read_csv("./stack_models/lay2PredsProbs_xgb_v13.csv")
testPreds_xgbLay2_v16 <- read_csv("./stack_models/lay2PredsProbs_xgb_v16.csv")
testPreds_xgbLay2_v18 <- read_csv("./stack_models/lay2PredsProbs_xgb_v18.csv")
...
xgb18fullpreds$id <- NULL
xgb19fullpreds$id <- NULL
...
testPreds_xgbLay2_v1$id <- NULL
testPreds_xgbLay2_v2$id <- NULL
testPreds_xgbLay2_v7$id <- NULL
testPreds_xgbLay2_v9$id <- NULL
testPreds_xgbLay2_v10$id <- NULL
testPreds_xgbLay2_v11$id <- NULL
testPreds_xgbLay2_v13$id <- NULL
testPreds_xgbLay2_v16$id <- NULL
testPreds_xgbLay2_v18$id <- NULL

lay1fullpreds <- data.table(cbind(xgb4fullpreds,xgb5fullpreds,xgb6fullpreds, xgb14fullpreds, xgb15fullpreds, xgb17fullpreds, xgb18fullpreds, xgb19fullpreds, nn1fullpreds, nn2fullpreds,nn3fullpreds, nn4fullpreds, glmnet1fullpreds,rf1fullpreds,
                                  testPreds_xgbLay2_v1, testPreds_xgbLay2_v2, testPreds_xgbLay2_v7, testPreds_xgbLay2_v9, testPreds_xgbLay2_v10, testPreds_xgbLay2_v11, testPreds_xgbLay2_v13, testPreds_xgbLay2_v16, testPreds_xgbLay2_v18))
# Predict the test set using the XGBOOST stacked model
colnames(lay1fullpreds) <- colnames(lay1preds[,2:ncol(lay1preds), with=FALSE])


set.seed(201510)
(tme <- Sys.time())
xgbLay2_v20_full <- xgb.train(data = dtrain,
                              params = param,
                              nrounds = rounds,
                              maximize=TRUE,
                              # watchlist=watchlist,
                              print.every.n = 5)
Sys.time() - tme
save(xgbLay2_v20_full, file="./stack_models/xgbLay2_v20_full.rda")

lay2Preds <- predict(xgbLay2_v20_full, newdata=data.matrix(lay1fullpreds))
...
sampID <- sort(sampID)
write.csv(data.frame(id=sampID, t(lay2Preds)), "./stack_models/lay2PredsProbs_xgb_v20.csv", row.names=FALSE)
...
write.csv(submission, "./stack_models/lay2Preds_xgb_v20.csv", quote=FALSE, row.names = FALSE)

xgbLay2v20Imp <- xgb.importance(feature_names = colnames(lay1preds), model=xgbLay2_v20_full )
write_csv(xgbLay2v20Imp, "./stack_models/xgbLay2v20Imp.csv")
