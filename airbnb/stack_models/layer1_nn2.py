...
pca = PCA(n_components= .9999, whiten=True)
...
#                 noise0_sigma=2,
                 ...
                 objective_lambda1=0.0000001,
                 objective_loss_function=categorical_crossentropy,
                 
                 update=adam,
                 update_learning_rate=theano.shared(float32(0.0006), borrow=True),
#                 update_momentum=theano.shared(float32(0.001), borrow=True),
                 update_beta1=0.95,
                 update_beta2=0.999,
                 update_epsilon=1e-05,
                 on_epoch_finished=[
...
# Save 
foldPredFrame.to_csv("/home/branden/Documents/kaggle/airbnb/stack_models/cvPreds_nn2.csv", index=False)
...
## Save 
#test_pred_frame.to_csv("/home/branden/Documents/kaggle/airbnb/stack_models/testPredsProbs_nn2.csv", index=False)
...
# Save 
testPredFrame.to_csv("/home/branden/Documents/kaggle/airbnb/stack_models/testPredsProbs_nn2.csv", index=False)
