...
leak <- fread("./data_trans/data_trans_leak_wtdprops.csv", key="id2")
...
set.seed(2021)
samp <- sample(1:31400000, 2000000, replace=FALSE)
...
fwrite(submission, "./stack_models/L1/testPreds/L1_testPreds_xgb1_v22.csv")
fwrite(data.table(id=seq(0,nrow(testPreds_top5)-1,1),testPreds), "./stack_models/L1/testPreds/L1_testPreds_xgb1_v22_probs.csv")
