...
for (i in 1:loops){
    ...
    fwrite(data.table(id=seq(0,nrow(testPreds)-1,1),testPreds), paste0("./stack_models/L1/testPreds/L1_testPreds_xgb4_loop",i,"_probs.csv"))
...
fwrite(submission, "./stack_models/L1/testPreds/L1_testPreds_xgb4_loop.csv")
fwrite(data.table(id=seq(0,nrow(testPreds_top5)-1,1),testPreds), "./stack_models/L1/testPreds/L1_testPreds_xgb4_loop_probs.csv")
